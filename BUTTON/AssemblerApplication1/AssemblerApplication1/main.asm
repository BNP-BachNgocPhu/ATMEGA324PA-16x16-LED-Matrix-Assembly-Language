		.EQU PORT_KEYPAD = PORTB	
		.EQU PORT_KEYPAD_DR = DDRB
		.EQU INPORT_KEYPAD = PINB
		.DEF VALUE = R24
...
WAIT:	
		LDI R16,$FF
		OUT PORT_KEYPAD,R16
		LDI R17,$3B ;0x00111011 QUET COT DAU TIEN
		LDI R18,0 ; GIA TRI HANG DAU TIEN
		LDI R19,2 ; COT QUET
		RCALL SCANKEY
		//RCALL DELAY_500MS
		CPI VALUE,0
...
LP_SET_B_D:
		...
		RET	
;------------------------------------------	
; CHUONG TRINH SCANKEY
SCANKEY:
		OUT PORT_KEYPAD,R17
		NOP ; THOI GIAN DE ON DINH
		SBIC INPORT_KEYPAD,3 ;KIEM TRA HANG 0
		RJMP KEYPAD_SCAN_CHECK_COL2
		LDI R16,200
		RCALL DELAY_100US ;CHONG RUNG
		RCALL DELAY_100US ;CHONG RUNG 
		RCALL DELAY_100US ;CHONG RUNG
		RCALL DELAY_100US ;CHONG RUNG
		RCALL DELAY_100US ;CHONG RUNG
		...
		RCALL DELAY_100US ;CHONG RUNG
		RCALL DELAY_100US ;CHONG RUNG   
		SBIC INPORT_KEYPAD,3 ;KIEM TRA HANG 0 LAI
		RJMP KEYPAD_SCAN_CHECK_COL2
		RJMP KEYPAD_FOUND
KEYPAD_SCAN_CHECK_COL2: 
		SBIC INPORT_KEYPAD,4 ;KIEM TRA HANG 1
		...
		RCALL DELAY_100US ;CHONG RUNG
		RCALL DELAY_100US ;CHONG RUNG    
		SBIC INPORT_KEYPAD,4 ;KIEM TRA HANG 1 LAI
		RJMP KEYPAD_SCAN_CHECK_COL3
		LDI R18,1
		RJMP KEYPAD_FOUND
KEYPAD_SCAN_CHECK_COL3:
		SBIC INPORT_KEYPAD,5 ;KIEM TRA HANG 2
		...
		RCALL DELAY_100US ;CHONG RUNG
		RCALL DELAY_100US ;CHONG RUNG 
		SBIC INPORT_KEYPAD,5 ;KIEM TRA HANG 2 LAI
		RJMP KEYPAD_SCAN_NEXT_ROW
		LDI R18,2
		RJMP KEYPAD_FOUND
KEYPAD_SCAN_NEXT_ROW:
		CPI R19,0 ; KIEM TRA DA QUET HET CHUA
		BREQ KEYPAD_NOT_FOUND
		DEC R19
		ROR R17
		RJMP SCANKEY
KEYPAD_FOUND:
